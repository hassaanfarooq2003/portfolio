  ...
  return (
    ...
    >
      ...
      <div className="flex items-center space-x-2 sm:space-x-4 min-w-0 flex-nowrap">
        <a href="https://github.com/hassaanfarooq2003?tab=repositories" className="text-gray-400 hover:text-white transition-colors">
        ...
        <a href="https://www.linkedin.com/in/hassaan-farooq-844541148/" className="text-gray-400 hover:text-white transition-colors">
          <svg className="w-5 h-5 sm:w-7 sm:h-7" fill="currentColor" viewBox="0 0 24 24">
